...
must_haves:
  ...
  key_links:
    ...
    - from: "InsuranceXmlService.ExportXmlAsync"
      to: "BhxhGatewayOptions"
      via: "IOptions<BhxhGatewayOptions> for FacilityCode in file naming"
      pattern: "_gatewayOptions\\.FacilityCode"
---
...
<task type="auto">
  ...
  <action>
    ...
    4. REWRITE `ExportXmlAsync` in InsuranceXmlService:
       ...
       - Also inject `IOptions<BhxhGatewayOptions>` to get FacilityCode for file naming (BhxhGatewayOptions created in Plan 01)

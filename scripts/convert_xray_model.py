...
def convert(variant: str = "densenet121-res224-all"):
    """
    Variants:
    ...
    output_file = f"chestxray_{safe_name}.onnx"
    ...
    torch.onnx.export(
        ...
        opset_version=17,
        dynamo=False,  # use legacy tracing export to bypass new torch.export limitations
    )

...
const ROUTES = [
  '/v2/endpoint-security', '/v2/reagent-management', '/v2/sample-storage',
  '/v2/sample-tracking', '/v2/inter-hospital', '/v2/clinical-guidance',
  '/v2/medical-forensics', '/v2/occupational-health', '/v2/methadone-treatment',
  '/v2/immunization',
];

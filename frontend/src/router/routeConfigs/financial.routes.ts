...
export const financialV2Routes: RouteEntry[] = [
  ...
  { path: 'insurance',            Component: InsuranceV2,           meta: { title: 'Giám định BHYT',              group: 'finance', permission: 'Insurance.Read',   workspace: 'backoffice',  module: 'BHYT' } },
  { path: 'bhyt-full-coverage',   Component: BhytFullCoverageV2,    meta: { title: 'BN BHYT chi trả 100%',        group: 'finance', permission: 'Insurance.Read',   workspace: 'backoffice',  module: 'BHYT' } },
  { path: 'bhxh-audit',           Component: BhxhAuditV2,           meta: { title: 'BHXH kiểm tra',               group: 'finance', permission: 'Insurance.Read',   workspace: 'backoffice',  module: 'BHYT' } },

  // dup #375: ProcurementRequestsV2 was dead (RR matched ProcurementV2 first) — dropped, behavior-preserving
  { path: 'procurement',          Component: ProcurementV2,         meta: { title: 'Đề xuất - Dự trù',            group: 'finance', permission: 'Pharmacy.Read',    workspace: 'pharmacy',    module: 'DUOCKHO' } },
  { path: 'finance-catalogs',     Component: FinanceCatalogsV2,     meta: { title: 'DM Tài chính',                group: 'finance', permission: 'System.Configure', workspace: 'frontoffice', module: 'THUNGAN' } },
  ...
  { path: 'bhxh-config',          Component: BhxhConfigV2,          meta: { title: 'Cấu hình BHXH',               group: 'finance', permission: 'System.Configure', workspace: 'backoffice',  module: 'BHYT' } },

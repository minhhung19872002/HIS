...
export const financialV2Routes: RouteEntry[] = [
  ...
  { path: 'billing/edit', Component: BillingEditorV2, meta: { title: 'Viện phí (chỉnh sửa)', group: 'finance', permission: 'Billing.Read', workspace: 'frontoffice', module: 'THUNGAN' } },
  ...
  { path: 'insurance', Component: InsuranceV2, meta: { title: 'Giám định BHYT', group: 'finance', workspace: 'backoffice', module: 'BHYT' } },
  { path: 'bhyt-full-coverage', Component: BhytFullCoverageV2, meta: { title: 'BN BHYT chi trả 100%', group: 'finance', workspace: 'backoffice', module: 'BHYT' } },
  { path: 'bhxh-audit', Component: BhxhAuditV2, meta: { title: 'BHXH kiểm tra', group: 'finance', workspace: 'backoffice', module: 'BHYT' } },
  // dup #375: ProcurementRequestsV2 was dead (RR matched ProcurementV2 first) — dropped, behavior-preserving
  { path: 'procurement', Component: ProcurementV2, meta: { title: 'Đề xuất - Dự trù', group: 'finance', workspace: 'pharmacy', module: 'DUOCKHO' } },
  { path: 'finance-catalogs', Component: FinanceCatalogsV2, meta: { title: 'DM Tài chính', group: 'finance', workspace: 'frontoffice', module: 'THUNGAN' } },
  ...
  { path: 'receipt-book-admin', Component: ReceiptBookAdminV2, meta: { title: 'Quản lý sổ biên lai', group: 'finance', permission: 'Billing.Read', workspace: 'frontoffice', module: 'THUNGAN' } },
  { path: 'bhxh-config', Component: BhxhConfigV2, meta: { title: 'Cấu hình BHXH', group: 'finance', workspace: 'backoffice', module: 'BHYT' } },
  { path: 'payment-reports', Component: PaymentReportsV2, meta: { title: 'Báo cáo thanh toán', group: 'finance', permission: 'Billing.Read', workspace: 'frontoffice', module: 'THUNGAN' } },

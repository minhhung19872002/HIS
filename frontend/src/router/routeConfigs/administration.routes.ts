...
export const administrationV2Routes: RouteEntry[] = [
  // --- management group ---
  { path: 'admin', Component: SystemAdminV2, meta: { title: 'Quản trị hệ thống', group: 'management', permission: 'System.Configure' } },
  ...
  { path: 'endpoint-security', Component: EndpointSecurityV2, meta: { title: 'An toàn thông tin', group: 'management', permission: 'System.Configure' } },
  ...
  { path: 'backup-management', Component: BackupManagementV2, meta: { title: 'Quản lý Backup', group: 'management', permission: 'System.Configure' } },
  { path: 'his-connections', Component: HisConnectionsV2, meta: { title: 'Kết nối HIS', group: 'management', permission: 'System.Configure' } },
  { path: 'kiosk', Component: KioskSelfServiceV2, meta: { title: 'Kiosk tự phục vụ', group: 'management' } },
  { path: 'reports', Component: ReportsV2, meta: { title: 'Báo cáo', group: 'management', permission: 'Report.Read' } },
  { path: 'reports/waiting-time', Component: WaitingTimeReportV2, meta: { title: 'Phân tích thời gian chờ', group: 'management', permission: 'Report.Read' } },
  { path: 'report-catalogs', Component: ReportCatalogsV2, meta: { title: 'DM Nhóm BC', group: 'management', permission: 'Report.Read' } },
  ...
  { path: 'workload-report', Component: WorkloadReportV2, meta: { title: 'Báo cáo khối lượng công việc', group: 'management', permission: 'Report.Read' } },
  { path: 'catalogs-admin', Component: CatalogsAdminV2, meta: { title: 'Quản trị danh mục', group: 'management', permission: 'System.Configure' } },

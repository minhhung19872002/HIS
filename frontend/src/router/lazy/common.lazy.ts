...
export const DashboardV2 = lazy(() => import('../../modules/system/pages/Dashboard'));
...
export const SatisfactionSurveyV2 = lazy(() => import('../../modules/survey/pages/SatisfactionSurvey'));
export const PatientPortalStaffV2 = lazy(() => import('../../modules/portal/pages/PatientPortalStaff'));
export const MobileHomeV2 = lazy(() => import('../../modules/portal/pages/MobileHome'));

...
const BookingManagementV2: React.FC = () => {
  ...
  const scheduleFields: CrudFieldCfg[] = [
    ...
    // Trước đây là ô text bắt gõ tay đúng "HH:mm" — người dùng bấm vào không chọn được giờ.
    { key: 'startTime', label: 'Giờ bắt đầu', type: 'time', required: true, placeholder: 'Chọn giờ bắt đầu',
      rules: [{ required: true, message: 'Chọn giờ bắt đầu' }] },
    { key: 'endTime', label: 'Giờ kết thúc', type: 'time', required: true, placeholder: 'Chọn giờ kết thúc',

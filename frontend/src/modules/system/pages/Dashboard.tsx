...
import * as receptionApi from '../../reception/api/reception';
import type { AdmissionDto, OpdFlowStatsDto } from '../../reception/api/reception';
import * as surgeryApi from '../../surgery/api/surgery';
import type { SurgeryScheduleDto } from '../../surgery/api/surgery';
import * as inpatientApi from '../../inpatient/api/inpatient';
import type { WardLayoutDto, BedLayoutDto } from '../../inpatient/api/inpatient';
import * as pharmacyApi from '../../pharmacy/api/pharmacy';
import type { PendingPrescription } from '../../pharmacy/api/pharmacy';
import * as warehouseApi from '../../pharmacy/api/warehouse';
import type { ExpiryWarningDto } from '../../pharmacy/api/warehouse';
import * as alertsApi from '../../patient/api/businessAlerts';
import type { BusinessAlertDto } from '../../patient/api/businessAlerts';

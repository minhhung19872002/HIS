    ...
    <div className="ab">
      ...
      {!mr && !loading && (
        <div style={{ padding: 80, textAlign: 'center', color: 'var(--t-2)' }}>
          ...
          <div style={{ fontSize: 'var(--fs-sm)', marginTop: 'var(--space-6)' }}>Có thể cho lại các CLS sau khi hoàn hóa đơn</div>
        </div>
      )}
      ...
      {mr && services.length === 0 && !loading && (
        <div style={{ padding: 60, textAlign: 'center', color: 'var(--t-2)' }}>
          ...
          <div style={{ fontSize: 'var(--fs-sm)', marginTop: 'var(--space-8)' }}>Hồ sơ {mr.code} không có dịch vụ nào bị hủy</div>
        </div>
      )}
      ...
      >
        <div style={{ padding: 'var(--space-12)', background: 'var(--d-1)', border: '1px solid var(--line)', borderRadius: 4, marginBottom: 'var(--space-12)' }}>
          ...
          <div style={{ fontSize: 'var(--fs-sm)', marginTop: 'var(--space-4)' }}>

...
const HIS_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { id: 'reception',         path: '/v2/reception',                label: '[24] Tiếp đón' },
      { id: 'opd',               path: '/v2/opd',                      label: '[24] Khám bệnh', hot: 8 },
      { id: 'telemedicine',      path: '/v2/telemedicine',             label: 'Khám từ xa' },
      { id: 'prescription',      path: '/v2/prescription',             label: '[24] Kê đơn' },
      { id: 'ipd',               path: '/v2/ipd',                      label: '[24] Nội trú' },
      { id: 'er',                path: '/v2/emergency-disaster',       label: '[24] Cấp cứu', hot: 6 },
      { id: 'or',                path: '/v2/surgery',                  label: '[24] Phẫu thuật' },
      { id: 'emr',               path: '/v2/emr',                      label: '[24] Hồ sơ BA (EMR)' },
      ...
      { id: 'appointment',       path: '/v2/appointment-booking',      label: '[24] Đặt lịch hẹn' },
      { id: 'treatment-protocols', path: '/v2/treatment-protocols',    label: '[24] Phác đồ điều trị' },
      { id: 'chronic-disease',   path: '/v2/chronic-disease',          label: 'Bệnh mạn tính' },
      { id: 'tb-hiv',            path: '/v2/tb-hiv',                   label: 'Quản lý Lao/HIV' },
      { id: 'consultation',      path: '/v2/consultation',             label: '[24] Hội chẩn' },
      { id: 'doctor-portal',     path: '/v2/doctor-portal',            label: '[24] Cổng bác sĩ' },
      { id: 'clinical-catalogs', path: '/v2/clinical-catalogs',        label: '[24] DM Lâm sàng' },
    ],
  },
  {
    id: 'paraclinical', label: 'Cận lâm sàng', short: 'CLS', icon: 'flask', hot: 3,
    items: [
      { id: 'lab',                path: '/v2/lab',                label: '[24] Xét nghiệm', hot: 3 },
      { id: 'lab-qc',             path: '/v2/lab-qc',             label: '[24] QC Kiểm định' },
      { id: 'microbiology',       path: '/v2/microbiology',       label: '[24] Vi sinh' },
      ...
      { id: 'sample-storage',     path: '/v2/sample-storage',     label: '[24] Lưu trữ mẫu' },
      { id: 'sample-tracking',    path: '/v2/sample-tracking',    label: '[24] Theo dõi mẫu' },
      ...
      { id: 'blood-bank',         path: '/v2/blood-bank',         label: '[24] Ngân hàng máu' },
      { id: 'paraclinical-catalogs', path: '/v2/paraclinical-catalogs', label: '[24] DM CLS' },
    ],
  },
  {
    ...
    items: [
      ...
      { id: 'pharmacy-catalogs',    path: '/v2/pharmacy-catalogs',    label: '[24] DM Dược' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { id: 'digital-signature', path: '/v2/digital-signature', label: '[24] Chữ ký số' },
      { id: 'central-signing',   path: '/v2/central-signing',   label: '[24] Ký số tập trung' },
      { id: 'signing-workflow',  path: '/v2/signing-workflow',  label: '[24] Quy trình ký' },
      // NangCap24
      { id: 'biometric-enrollment', path: '/v2/biometric-enrollment', label: '[24] Vân tay BN (WebAuthn)' },
      { id: 'master-data',       path: '/v2/master-data',       label: '[24] Danh mục' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'emergency-disaster', path: '/v2/emergency-disaster',   label: '[24] Cấp cứu / thảm hoạ' },
  ...
  },
  {
    ...
    items: [
      { id: 'health-checkup',       path: '/v2/health-checkup',       label: '[24] Khám sức khoẻ' },
  ...
  },
  {
    ...
    items: [
      { id: 'patient-portal',      path: '/v2/patient-portal',      label: '[24] Cổng bệnh nhân' },
      { id: 'satisfaction-survey', path: '/v2/satisfaction-survey', label: '[24] Khảo sát hài lòng' },

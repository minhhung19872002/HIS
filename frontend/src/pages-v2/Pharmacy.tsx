...
import { App as AntdApp, Modal, Table, Tag, Button } from 'antd';
import * as pharmacyApi from '../api/pharmacy';
import type { PendingPrescription, LoginExpiryAlert } from '../api/pharmacy';
import { SimpleV2Page, StatusBadge, ActBtn, Btn, type ColumnDef, type StatusTab } from './_v2kit';
import TermIcon from '../layouts/terminal/Icon';

// ── Expiry Alert Modal ────────────────────────────────────────────────────────
// Hiện khi vào module Dược, 1 lần / phiên (dùng sessionStorage để tránh spam).

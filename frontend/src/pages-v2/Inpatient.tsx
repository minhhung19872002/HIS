...
import { getInpatientList, getWardLayout, admitFromOpd, getPendingAdmissions, type PendingAdmissionDto } from '../modules/inpatient/api/inpatient';
import type { InpatientListDto, WardLayoutDto, BedLayoutDto } from '../modules/inpatient/api/inpatient';
import TreatmentMonitorSection from '../modules/inpatient/pages/TreatmentMonitorSection';
import ConsultationSection from '../modules/inpatient/pages/ConsultationSection';
import NewbornSection from '../modules/inpatient/pages/NewbornSection';
import HemodialysisSection from '../modules/inpatient/pages/HemodialysisSection';

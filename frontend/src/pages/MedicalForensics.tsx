    ...
    <Spin spinning={loading}>
      <div style={{ position: 'relative' }}>
        ...
        <Row gutter={16} style={{ marginBottom: 16 }}>
          <Col xs={12} sm={6}>
            <Card style={{ background: 'rgba(255,255,255,0.7)', backdropFilter: 'blur(10px)' }}><Statistic title="Tổng hồ sơ" value={stats.totalCases} prefix={<AuditOutlined />} styles={{ content: { color: '#1890ff' } }} /></Card>
          </Col>
          <Col xs={12} sm={6}>
            <Card style={{ background: 'rgba(255,255,255,0.7)', backdropFilter: 'blur(10px)' }}><Statistic title="Chờ giám định" value={stats.pendingCases} prefix={<ClockCircleOutlined />} styles={{ content: { color: '#faad14' } }} /></Card>
          </Col>
          <Col xs={12} sm={6}>
            <Card style={{ background: 'rgba(255,255,255,0.7)', backdropFilter: 'blur(10px)' }}><Statistic title="Hoàn thành tháng" value={stats.completedThisMonth} prefix={<CalendarOutlined />} styles={{ content: { color: '#52c41a' } }} /></Card>
          </Col>
          <Col xs={12} sm={6}>
            <Card style={{ background: 'rgba(255,255,255,0.7)', backdropFilter: 'blur(10px)' }}><Statistic title="TB % thương tật" value={stats.avgDisabilityPercent} suffix="%" prefix={<PercentageOutlined />} styles={{ content: { color: '#722ed1' } }} /></Card>
          </Col>
        </Row>
        </motion.div>

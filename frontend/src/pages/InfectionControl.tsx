...
import { INFECTION_TYPES } from './infection-control/constants';
import { buildInfectionReportHtml } from './infection-control/printTemplates';
...
const InfectionControl: React.FC = () => {
  ...
  const executePrintReport = () => {
    ...
    printWindow.document.write(buildInfectionReportHtml(haiCases, dashboard));

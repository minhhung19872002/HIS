...
import * as methadoneApi from '../modules/public-health/api/methadone';
import type { MethadonePatient, DoseRecord, UrineTest, MethadoneStats } from '../modules/public-health/api/methadone';

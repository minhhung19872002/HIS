...
const Inpatient: React.FC = () => {
  ...
  // Status tag + bed badge moved to ./inpatient/statusTags.tsx (K15 B1).
  ...
  const executePrint = () => {
    ...
    printWindow.document.write(buildMedicalRecordHtml(formValues, recordType, isNgoaiKhoa));
  ...
  const executePrintTreatmentTracking = () => {
    ...
    printWindow.document.write(buildTreatmentTrackingHtml(formValues));
    printWindow.document.close();
    printWindow.focus();

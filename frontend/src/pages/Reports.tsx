...
import {
  BhytCostReportsTab,
  AdminClsReportsTab,
  PharmacyExtReportsTab,
} from './reports/Nc10ReportTab';
import ReportBuilderTab from './reports/ReportBuilderTab';
...
// API Mapping
// ============================================================================
// ReportConfig + ReportCategoryConfig + ApiCategory moved to ./reports/types.ts (K17 B1)
...
// ReconciliationReportId moved to ./reports/types.ts (K17 B1)
...
// ReportField + CustomReportDef moved to ./reports/types.ts (K17 B1)
// DATA_SOURCES + OPERATORS + FORMATS + STORAGE_KEY moved to ./reports/constants.ts (K17 B1)
...
// Nc10ReportDef moved to ./reports/types.ts (K17 B1)
// bhytCostReports + adminClsReports + pharmacyExtReports moved to ./reports/constants.ts (K17 B1)

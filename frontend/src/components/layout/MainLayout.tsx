...
import NotificationBell from '@/modules/system/components/NotificationBell';
  ...
  const menuItems = [
    ...
    },
    {
      ...
      children: [
        ...
        { key: '/consultation-register', icon: <BookOutlined />, label: 'Sổ hội chẩn' },
    ...
    },
    {
      ...
      children: [
        ...
        { key: '/receipt-book-admin', icon: <ReadOutlined />, label: 'Sổ biên lai' },

...
// date: unknown — xem _shared.tsx ở SpecialtyEMRForms1.
...
// Xem chú thích Field ở SpecialtyEMRForms1/_shared.tsx — value: unknown để chấp nhận field tuỳ ý.
...
// content widen unknown để chấp nhận field từ DTO chưa khai báo strict (xem Field).
...
// Xem chú thích ở SpecialtyEMRForms1/_shared.tsx — kiểu rộng cho print template.

...
const pages = [
  ...
  { route: '/health-checkup', name: 'Health Checkup (Kham suc khoe)' },
  { route: '/immunization', name: 'Immunization (Tiem chung)' },
  { route: '/epidemiology', name: 'Epidemiology (Giam sat dich te)' },
  { route: '/school-health', name: 'School Health (Y te truong hoc)' },
  { route: '/occupational-health', name: 'Occupational Health (SK nghe nghiep)' },
  { route: '/methadone-treatment', name: 'Methadone Treatment (Methadone)' },
  { route: '/food-safety', name: 'Food Safety (ATVSTP)' },
  { route: '/community-health', name: 'Community Health (SK cong dong)' },
  { route: '/hiv-management', name: 'HIV Management (Quan ly HIV)' },
  { route: '/medical-forensics', name: 'Medical Forensics (Giam dinh Y khoa)' },
  { route: '/traditional-medicine', name: 'Traditional Medicine (Y hoc co truyen)' },
  { route: '/reproductive-health', name: 'Reproductive Health (SK sinh san)' },
  { route: '/mental-health', name: 'Mental Health (SK tam than)' },
  { route: '/environmental-health', name: 'Environmental Health (Moi truong y te)' },
  { route: '/trauma-registry', name: 'Trauma Registry (So chan thuong)' },
  { route: '/population-health', name: 'Population Health (Dan so KHHGD)' },

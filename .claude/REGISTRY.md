...
| whole-app deep QA sweep (parallel domain agents · static FE↔BE route/field/implicit-required scans · E2E flow replay · pre-push breaking-risk review · commit per domain) | `skills/his-qa-deep-sweep` | link; agent-quality gates → `skills/his-flow-multi-agent-orchestration` · guardrails → `skills/his-qa-anti-pattern` |

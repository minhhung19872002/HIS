...
- Tạo API client backend → dùng `his-api-client`.
- Tạo test cho page → dùng `his-e2e-testing`.
...
Nếu chưa có → tạo trước bằng skill `his-api-client`.

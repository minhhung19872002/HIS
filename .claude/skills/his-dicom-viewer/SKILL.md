...
## Khi nào KHÔNG dùng
- Page list/detail (`/v2/*`) → `his-frontend-page-v2`.
- CRUD phiếu CĐHA / kết quả RIS → backend/page skill thường.
- DICOM auto-send/transmission (gửi study sang PACS) → đó là backend (`his-backend-module-scaffold`/feature riêng), không phải viewer.
